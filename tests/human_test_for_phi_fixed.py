...
print("%8.2f  %8.2f  %8.2f  %8.2f       None %8.2f° --- default fit for angle " % (xc, yc, d_major, d_minor, np.degrees(phi_calc)))

phi_fixed = phi_true + np.radians(0)
xc, yc, d_major, d_minor, phi_calc = lbs.beam_size(beam, phi_fixed=phi_fixed)
print("%8.2f  %8.2f  %8.2f  %8.2f  %8.2f° %8.2f° --- should match" % (xc, yc, d_major, d_minor, np.degrees(phi_fixed), np.degrees(phi_calc)))

phi_fixed = phi_true + np.radians(90)
xc, yc, d_major, d_minor, phi_calc = lbs.beam_size(beam, phi_fixed=phi_fixed)
print("%8.2f  %8.2f  %8.2f  %8.2f  %8.2f° %8.2f° --- major/minor swapped" % (xc, yc, d_major, d_minor, np.degrees(phi_fixed), np.degrees(phi_calc)))
...
xc, yc, d_major, d_minor, phi_calc = lbs.beam_size(beam, phi_fixed=phi_fixed)
print("%8.2f  %8.2f  %8.2f  %8.2f  %8.2f° %8.2f° --- d_major=d_minor=127.5" % (xc, yc, d_major, d_minor, np.degrees(phi_fixed), np.degrees(phi_calc)))
